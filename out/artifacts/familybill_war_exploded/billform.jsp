...
<div id="head" style="background-color: #00FFFF; ; height:100px;" ><p align="left" style="font-size:50px; position:relative; top:20% ; left:10%">家庭记账 <a href="index.jsp" style="font-size: 30px; position:absolute; left: 80%;top: 10%;">登出</a></p>
